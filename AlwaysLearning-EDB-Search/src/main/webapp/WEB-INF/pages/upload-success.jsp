			...
			<div  class="row">
				...
				<div  class="row">
					...
					<div class="col-md-8">
								<div class="page-header">
								  <div align="center">
								   		<div ${flag}><span class="alert-link">${status} </span>${fileName} ${message}</div>
								  </div>
								</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       			...
       			<form name="uploader" method="POST" action="../User/upload"	enctype="multipart/form-data">
			    ...
			    <textarea  form="uploader" name="description" cols="60" rows="5" placeholder="Enter Description ..." required="required"></textarea>
			    <br><br>
